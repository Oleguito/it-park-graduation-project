    ...
    <>
      <div className="w-full mt-2">
        <div className={`w-full`}>
          <p className="ml-4 mt-4">Введите адрес электронной почты участника</p>
          <div className="flex ml-4 mt-4 mb-4 h-16 items-center">
            <div className="flex content-center justify-center w-1/5">
              <label htmlFor="project-title" className="">
                Email:
              </label>
            </div>
            <input
              ...
              className={`${css.email_input_box} w-3/5 h-12`}
            ></input>
          </div>
