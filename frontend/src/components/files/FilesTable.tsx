...
export const FilesTable = (props: { projectId: number }) => {
    ...
    useEffect(() => {
        ...
        .catch(error => console.log("Error occuring while fetching list of files: ", error));
        ...
        <div>
            <Dialog>
                ...
                <DialogContent className="max-w-[60rem] w-[60rem]">
                    <DialogHeader>
                        <DialogTitle className="text-[30px]">Прикрепленные файлы</DialogTitle>
                    </DialogHeader>
                    <DialogDescription>
                    </DialogDescription>
                    <Table>
